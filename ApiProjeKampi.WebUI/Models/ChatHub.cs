...
namespace ApiProjeKampi.WebUI.Models
{
    public class ChatHub : Hub
    {
        ...
        //OnConnectedAsync bağlantı gerçkliştirileceği zaman yapılacak işlemleri belirtmen için signalR dan gelen bir metottur
        ...
        //bu metot bağlantı kapatıldığı zaman ne yapılacagını anlatır
